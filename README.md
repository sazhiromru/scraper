1. ##Сбор данных##
   Сбор данных идем четырьмя скриптами.
   Для примера выклыдваю один.
   Сайт с бесконечной промоткой, нам нужно извлечь наименование и цену
   <details>
  <summary><strong>🖼️ Внешний вид сайта</strong></summary>
  ![Внешний вид сайта](https://raw.githubusercontent.com/sazhiromru/images/main/%D0%BC%D0%B0%D1%80%D0%BA%D0%B5%D1%82.PNG?raw=true)
<details>
